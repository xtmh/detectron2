...
register_coco_instances("tomato", {}, "./tests/Tomato/coco-1697610332.4844987.json", "./tests/tomato")  #ok
...
for name in ["s-IMG_2973"]:
    ...
    #print(num_instances)
    #for lbl in outputs["instances"].pred_classes.to('cpu'):
    #    v.draw_rotated_box_with_label(lbl)
    v.draw_text("test", (0,0), horizontal_alignment="left")
    v = v.get_output()
